...
[![Godoc](http://img.shields.io/badge/godoc-reference-blue.svg?style=flat)](https://godoc.org/gopkg.in/flocasts/dd-trace-go.v1/ddtrace)
...
```bash
go get gopkg.in/flocasts/dd-trace-go.v1/ddtrace/tracer
go get gopkg.in/flocasts/dd-trace-go.v1/profiler
```

Additionally there are many [contrib](./contrib) packages that can be installed as needed like this:

```
go get gopkg.in/flocasts/dd-trace-go.v1/contrib/gorilla/mux
```
